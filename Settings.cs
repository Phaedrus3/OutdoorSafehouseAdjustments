...
namespace OutdoorSafehouseAdjustments
{
    internal class OutdoorSafehouseSettings : JsonModSettings
    {
        ...
        [Section("Forsaken Airfield - Open Hangar")]

        [Name("Add a MakeShift Fire Barrel")]
        [Description("Add a MakeShift Fire Barrel.")]
        public bool FAOHAddFireBarrel = false;
        ...
        /*
        //Mountain Town
        [Section("Mountain Town - Hermits Cabin")]

        [Name("Move Cupboard")]
        [Description("Move the Cupboard.")]
        public bool MTHCMoveCupboard = false;

        [Name("Move Metal Box")]
        [Description("Move the Metal Box.")]
        public bool MTHCMoveMetalBox = false;

        [Name("Add a Second Cupboard")]
        [Description("Add a Second Cupboard.")]
        public bool MTHCAddCupboard = false;

        [Name("Add a Second Metal Box")]
        [Description("Add a Second Metal Box.")]
        public bool MTHCAddMetalBox = false;

        [Name("Add a Second Stove")]
        [Description("Add a Second Stove.")]
        public bool MTHCAddStove = false;

        [Name("Add a Second Wood Bin")]
        [Description("Add a Second Wood Bin.")]
        public bool MTHCAddWoodBin = false;

        [Name("Enable Hidden Larger Half of the Cabin")]
        [Description("Enable Hidden Larger Half of the Cabin, and Disable the Smaller Half.")]
        public bool MTHCEnableCabinHalf = false;
        */
